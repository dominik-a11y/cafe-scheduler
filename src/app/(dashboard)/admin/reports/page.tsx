...
import { getWeekRange, getMonthRange, DAY_NAMES_PL, formatDatePL, calculateHours, MONTH_NAMES_PL } from '@/lib/utils';
...
export default function ReportsPage() {
  ...
  const handlePdfExport = async (stat: EmployeeStats) => {
    ...
    try {
      ...
      await generateHoursRegistryPdf(stat.name, m, y, (data || []) as unknown as ScheduleEntryRow[]);
    } catch (e) {
